...
export const songs: Song[] = [
  ...
  },
  {
    ...
    ending: 'head',
    head: {
      chords: ['Dm9', 'G13', 'Em9', 'Fmaj9', 'Bbmaj9', 'A7alt', 'Dm9', 'Dm9'],
      melody: n(
        'A4@0/1.5 C5@1.5/.5 D5@2/1 E5@3/1 F5@4/2 E5@6/.5 D5@6.5/1.5 B4@8/1.5 D5@9.5/.5 G5@10/2 E5@12/1 F5@13/.5 A5@13.5/2.5 ' +
          'D5@16/1.5 F5@17.5/.5 A5@18/1 G5@19/1 E5@20/1 C#5@21/1 Bb4@22/.5 A4@22.5/1.5 C5@24/1 A4@25/1 E5@26/2',
      ),
    },
